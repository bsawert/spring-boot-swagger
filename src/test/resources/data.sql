...
insert into dog_dto(id, name, description, gender) values(1, 'Puppy', 'Puppy', 'FEMALE');
insert into dog_breed (fk_dog, fk_breed) values(1, 1);
insert into dog_breed (fk_dog, fk_breed) values(1, 2);

insert into dog_dto(id, name, description, gender) values(2, 'Lily', 'Lily', 'FEMALE');
insert into dog_breed (fk_dog, fk_breed) values(2, 1);
insert into dog_breed (fk_dog, fk_breed) values(2, 5);

insert into dog_dto(id, name, description, gender) values(3, 'Gidget', 'Gidget', 'FEMALE');
