...
insert into breed_dto(id, name, description, akcgroup) values(3, 'Breed 3', 'Breed 3', 'MISCELLANEOUS');

insert into dog_dto(id, name, description, gender) values(1, 'Dog X', 'Dog 1', 'NEUTERED');
